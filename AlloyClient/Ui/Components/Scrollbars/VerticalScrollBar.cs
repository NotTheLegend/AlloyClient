...
public class VerticalScrollBar : Sprite {
    ...
    public VerticalScrollBar(Container clipRect, VerticalScrollBarConfig config) {
        ...
        var scrollBarTexture = new NineSliceRect(new NineSliceConfig {
            SliceData = SliceLibrary.ScrollBarBg, Width = config.Width, Height = config.Height, Anchor = UiAnchor.TopMiddle, MouseEnabled = true
        });
        ...
        _scrollBarHandleTexture = new NineSliceRect(new NineSliceConfig {
            SliceData = SliceLibrary.ScrollBar, CutX = 4, CutY = 4, Width = config.Width, Height = handleHeight, Anchor = UiAnchor.TopMiddle, MouseEnabled = true
        });
