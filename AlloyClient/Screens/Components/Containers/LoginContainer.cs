...
public class LoginContainer : Overlay {
    ...
    public LoginContainer() {
        ...
        var title = new SimpleText(new TextConfig {
            Text = "Log in", FontSize = 22, FontType = FontType.Bold, X = Width / 2, Y = titleBackground.Height / 2, Color = 0xFFFFFF,
        ...
        var registerConfig = new TextButtonConfig {
            Text = "New user? Click here to Register!", FontSize = 16, OnClicked = () => { OverlayManager.Set(new RegisterContainer()); },
        ...
        var loginConfig = new TextButtonConfig {
            Text = "Log in", FontSize = 28, OnClicked = OnLogin, FontType = FontType.Normal, X = Width - 25, Y = Height - 25,
