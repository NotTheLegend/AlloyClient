...
public class LoginContainer : Overlay {
    ...
    public LoginContainer() {
        ...
        var loginConfig = new TextButtonConfig { Text = "Log in", FontSize = 28, OnClicked = OnLogin, FontType = FontType.Normal, X = Width - 25, Y = Height - 25, Anchor = UiAnchor.BottomRight };
