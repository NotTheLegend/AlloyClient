...
public class RegisterContainer : Overlay {
    ...
    public RegisterContainer() {
        ...
        var title = new SimpleText(new TextConfig {
            Text = "Register", FontSize = 22, FontType = FontType.Bold, X = Width / 2, Y = titleBackground.Height / 2, Color = 0xFFFFFF,
        ...
        var emailConfig = new InputConfig {
            X = Width / 2, Y = 100, FontSize = 24, FontType = FontType.Bold, Color = 0xFFFFFF, Width = 350, DefaultText = "Username",
            Anchor = UiAnchor.Middle
        };
        ...
        var passwordConfig = new InputConfig {
            X = Width / 2, Y = 160, FontSize = 24, FontType = FontType.Bold, Color = 0xFFFFFF, Width = 350, DefaultText = "Password",
            Password = true, Anchor = UiAnchor.Middle
        };
        ...
        var registerConfig = new TextButtonConfig {
            Text = "Existing user? Click here to login!", FontSize = 16, OnClicked = () => { OverlayManager.Set(new LoginContainer()); },
            FontType = FontType.Bold, X = Width / 2, Y = _passwordInput.Y + 40, Anchor = UiAnchor.Middle
        };
        ...
        var loginConfig = new TextButtonConfig {
            Text = "Create", FontSize = 28, OnClicked = OnRegister, FontType = FontType.Normal, X = 475 - 25, Y = Height - 25,
        ...
        var cancelConfig = new TextButtonConfig {
            Text = "Cancel", FontSize = 28, OnClicked = CloseOverlay, FontType = FontType.Normal,
            X = loginButton.X - loginButton.Width - 35, Y = Height - 25, Anchor = UiAnchor.RightBottom
        };
